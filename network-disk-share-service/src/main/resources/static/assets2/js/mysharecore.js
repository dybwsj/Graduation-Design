...
function ajax() {
    var a = $(this).data("key");
    if (a == "all") {
        location.href = "http://localhost:8082/" + "#/" + a + "?path=/"
    } else {
        if (a == "myShare") {
            location.href = "http://localhost:8086/share/manage/" + $("#uid").val() + "/"
        } else {
            location.href = "http://localhost:8082/" + "#/" + a
        }
    }
}
...
function loadContent() {
    ...
    $.ajax({
        url: "http://localhost:8086/share/sharelist",
        type: "get",
...
function unShare(a) {
    $.ajax({
        url: "http://localhost:8086/share/unshare",
        type: "get",
